...
def read_img_subset(root_path, jpeg_root_path):
    ...
    for c in range(0, 43):
        ...
        prefix = os.path.join(root_path, format(c, '05d'))  #./GTSRB/Final_Training/images/00000 #org
        jpeg_prefix = os.path.join(jpeg_root_path, format(c, '05d')) #./GTSRB/Final_Training/images/JPEGImages/00000 #target
        anno_path = os.path.join(prefix, ('GT-' + format(c, '05d') + '.csv')) #label table #./GTSRB/Final_Training/images/00001/GT-00000.csv
        ...
        with open(anno_path) as gt_file:
            ...
            for row in gt_reader:
                if count == 0:
                    ...
                    img_name = row[0].split(';')[0] #00000_00000.ppm
                    img = plt.imread(os.path.join(prefix, img_name)) #./GTSRB/Final_Training/images/00000/00000_00000.ppm
...
def main(argv):
    Cnn_Path=argv[1]
    # Cnn_Path = "./GTSRB/Final_Training/Images"

    read_img_subset(Cnn_Path, Cnn_Path+'/JPEGImages')
